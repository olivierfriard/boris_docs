...
Send bug reports and features request by e-mail (see web site www.boris.unito.it) or by using the BORIS GitHub repository (https://github.com/olivierfriard/BORIS).
