...
BORIS will ask for selecting a directory. After this for each selected observation and subject 3 files will be created with the following
extensions: .dat, .faf, .fmt.
